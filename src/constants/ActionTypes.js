...
export const SAVE_APOLLO_UPDATE_CUSTOMER_MASTER = 'SAVE_APOLLO_CUSTOMER_MASTER';
export const SAVE_APOLLO_UPDATE_CONTRACTS = 'SAVE_APOLLO_CONTRACTS';
export const SAVE_APOLLO_UPDATE_CREDIT = 'SAVE_APOLLO_CREDIT';
export const SAVE_APOLLO_UPDATE_PRICING = 'SAVE_APOLLO_PRICING';
export const SAVE_APOLLO_UPDATE_GLOBALTRADE = 'SAVE_APOLLO_GLOBALTRADE';

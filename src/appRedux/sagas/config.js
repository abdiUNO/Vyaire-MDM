...
export const endpoints = {
    ...
    getTaxJurisdiction:'https://jtty8uwg44.execute-api.us-east-2.amazonaws.com/dev',
    saveApolloCustMaster: 'https://9tqwkgmyvl.execute-api.us-east-2.amazonaws.com/dev',
    saveApolloCredit:'https://le20ua4yy8.execute-api.us-east-2.amazonaws.com/dev',
    saveApolloContracts:'https://4n9j07d74f.execute-api.us-east-2.amazonaws.com/dev',
    addDocument:'https://hap7d2tr48.execute-api.us-east-2.amazonaws.com/dev',
    saveApolloPricing:'https://5zdqyo520e.execute-api.us-east-2.amazonaws.com/dev',
    saveApolloGlobalTrade:'https://4c4mjyf70b.execute-api.us-east-2.amazonaws.com/dev',
    getFunctionalGroupDetails:'https://ojsjl6n8q7.execute-api.us-east-2.amazonaws.com/dev',
    getMyTasks:'https://33p9kiusdk.execute-api.us-east-2.amazonaws.com/dev/',
    getStatusBarDetails:'https://q43ik9wi02.execute-api.us-east-2.amazonaws.com/dev',
    MdmCreateCustomer:'https://82fpwwhs4i.execute-api.us-east-2.amazonaws.com/dev',
    getSAPCustomerDetails:'https://4surjj7ore.execute-api.us-east-2.amazonaws.com/dev',
    searchCustomers:'https://xserl94dij.execute-api.us-east-2.amazonaws.com/dev',
    advanceSearchCustomers:'https://xserl94dij.execute-api.us-east-2.amazonaws.com/dev',
}
